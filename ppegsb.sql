...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  jeu. 07 mars 2019 à 13:06
...
CREATE TABLE IF NOT EXISTS `fiche_frais` (
  ...
  PRIMARY KEY (`FF_MOIS_FICHE_FRAIS`),
  KEY `FK_FICHE_FRAIS_VIS_MATRICULE_VISITEUR` (`VIS_MATRICULE_VISITEUR`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `inclure` (
  ...
  PRIMARY KEY (`FF_MOIS_FICHE_FRAIS`,`TF_CODE_TYPE_FRAIS`),
  KEY `FK_INCLURE_TF_CODE_TYPE_FRAIS` (`TF_CODE_TYPE_FRAIS`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `fiche_frais`
  ADD CONSTRAINT `FK_FICHE_FRAIS_VIS_MATRICULE_VISITEUR` FOREIGN KEY (`VIS_MATRICULE_VISITEUR`) REFERENCES `visiteur` (`VIS_MATRICULE_VISITEUR`);
...
--
ALTER TABLE `inclure`
  ADD CONSTRAINT `FK_INCLURE_FF_MOIS_FICHE_FRAIS` FOREIGN KEY (`FF_MOIS_FICHE_FRAIS`) REFERENCES `fiche_frais` (`FF_MOIS_FICHE_FRAIS`),
  ADD CONSTRAINT `FK_INCLURE_TF_CODE_TYPE_FRAIS` FOREIGN KEY (`TF_CODE_TYPE_FRAIS`) REFERENCES `type_frais` (`TF_CODE_TYPE_FRAIS`);
